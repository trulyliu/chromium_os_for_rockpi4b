...
CROS_WORKON_REPO=("git://git.denx.de" "https://github.com/rockchip-linux" "https://github.com/trulyliu")
CROS_WORKON_COMMIT=("9659eb46af6249b6e4b3712e60a1eb2e87fc48a1" "9fc33aee92908b538ca6687550be437415efae8e" "1b0344194b1ea807f3c851974f865f25d6cf0f0c")
CROS_WORKON_TREE=("2d7e7149804ddbf6d0bc5e6cb3dd20706be45809" "fa6123a12ef531a46cdac86eb8ca94fe67ed336d" "11273ba283496c4205d6fd1d39a0b8a08059708f")
...
CROS_WORKON_LOCALNAME=("${PN}" "rkbini" "toolchain")
...
src_configure() {
	pushd ${UBOOT_DESTDIR}
        patch -p1 < ${FILESDIR}/0001-Enable-LZ4-kernel-image-support-for-rock960-rk3399.patch
        ...
        CROSS_PREFIX="${TOOLCHAIN_DESTDIR}/${TOOLCHAIN_NAME}/bin/aarch64-linux-gnu-"
...
img_pack() {
        RKBL_DDR800_BIN=$(get_file_path ${RKBIN_DESTDIR} 'rk3399_ddr_800MHz_v*.bin')
        RKBL_MINILOADER_BIN=$(get_file_path ${RKBIN_DESTDIR} 'rk3399_miniloader_v*.bin')
	RKBL31_ELF=$(get_file_path ${RKBIN_DESTDIR} 'rk3399_bl31_v*.elf')
